...
<html lang="en">
  ...
  <body style="background: url(https://wallpaperaccess.com/full/1447364.jpg); background-size:cover;">
...
<form action="" method="post" style="width:500px; height:300px; padding:15px; position:absolute; left: 35%;; top:35%; background-color:rgba(255,255,255,0.3); border-radius:15px; box-shadow: 2px 2px 2px 2px black;">
  ...
  <button type="button" class="btn btn-primary"><a href="index.php"style="color:white; text-decoration:none;">Sign Up</a></button>
</form>
